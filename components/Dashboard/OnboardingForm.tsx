...
export default function OnboardingForm({ onClose }: OnboardingFormProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Show terms and conditions instead of completing onboarding immediately
  ...
  const handleTermsAccept = () => {
    // Complete the onboarding process after terms are accepted
  ...
  const handleTermsCancel = () => {
    // Go back to the form if terms are canceled
    setShowTerms(false);
  };
  ...
  return (
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4">
      {showTerms ? (
        <TermsAndConditions onAccept={handleTermsAccept} onCancel={handleTermsCancel} />
      ) : (
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="space-y-4">
                <div className="space-y-1">
                  <label className="block text-sm font-medium text-gray-700">
                    Company Name {isFieldMissing("companyName") && (
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="space-y-1">
                    <label className="block text-sm font-medium text-gray-700">
                      Business Type {isFieldMissing("businessType") && (
                        <span className="text-red-500">*</span>
                      )}
                    </label>
                    <select
              ...
              <div className="space-y-4">
                <div className="grid grid-cols-2 gap-4">
                  <div className="space-y-1">
                    <label className="block text-sm font-medium text-gray-700">
                      Phone Number {isFieldMissing("phoneNumber") && (
                        <span className="text-red-500">*</span>
                      )}
                    </label>
                    <input
                  ...
                  <div className="space-y-1">
                    <label className="block text-sm font-medium text-gray-700">
                      Pincode {isFieldMissing("pincode") && (
                        <span className="text-red-500">*</span>
                      )}
                    </label>
                    <input

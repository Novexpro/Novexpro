    ...
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-[100] flex items-center justify-center p-4">
      <div className="bg-white rounded-lg shadow-lg w-full max-w-lg mx-auto flex flex-col" style={{ maxHeight: "80vh" }}>
        ...
        <div className="overflow-y-auto p-4 flex-grow">
            ...
            <h3 className="text-lg font-semibold mb-2 mt-4">2. Services Offered</h3>
            ...
            <h3 className="text-lg font-semibold mb-2 mt-4">3. Terms of Use</h3>
            <h4 className="text-base font-medium mb-2">3.1 Data Reliability</h4>
            <ul>
            ...
            <h4 className="text-base font-medium mb-2 mt-3">3.2 AI & Automation Disclaimer</h4>
            <ul>
            ...
            <h4 className="text-base font-medium mb-2 mt-3">3.3 Market Risk Disclaimer</h4>
            <ul>
            ...
            <h4 className="text-base font-medium mb-2 mt-3">3.4 Platform Availability</h4>
            <ul>
            ...
            <h4 className="text-base font-medium mb-2 mt-3">3.5 Indemnification</h4>
            ...
            <h3 className="text-lg font-semibold mb-2 mt-4">4. Privacy Policy</h3>
            <h4 className="text-base font-medium mb-2">4.1 Data Collected</h4>
            <ul>
            ...
            <h4 className="text-base font-medium mb-2 mt-3">4.2 How We Use Data</h4>
            <ul>
            ...
            <h4 className="text-base font-medium mb-2 mt-3">4.3 Data Protection</h4>
            <ul>
            ...
            <h3 className="text-lg font-semibold mb-2 mt-4">5. Cookie Policy</h3>
            <h4 className="text-base font-medium mb-2">5.1 Cookies We Use</h4>
            <ul>
              <li>Functional cookies (session management)</li>
              <li>Analytics cookies (e.g., Google Analytics, Meta Pixel – to be added later)</li>
            </ul>

            <h4 className="text-base font-medium mb-2 mt-3">5.2 Consent</h4>
            <ul>
            ...
            <h3 className="text-lg font-semibold mb-2 mt-4">6. Subscription & Refund Policy</h3>
            <h4 className="text-base font-medium mb-2">6.1 Paid Services</h4>
            <ul>
            ...
            <h4 className="text-base font-medium mb-2 mt-3">6.2 No Refunds</h4>
            <ul>
              <li>All payments are non-refundable.</li>
              <li>Users may cancel future renewals at any time through account settings.</li>
            </ul>

            <h4 className="text-base font-medium mb-2 mt-3">6.3 Billing</h4>
            <ul>
            ...
            <h3 className="text-lg font-semibold mb-2 mt-4">7. User Responsibilities</h3>
            <p>
            ...
            <h3 className="text-lg font-semibold mb-2 mt-4">8. Changes to This Agreement</h3>
            <ul>
            ...
            <h3 className="text-lg font-semibold mb-2 mt-4">9. Governing Law & Jurisdiction</h3>
            <ul>
            ...
            <h3 className="text-lg font-semibold mb-2 mt-4">10. Arbitration Clause (for claims exceeding ₹10 lakhs)</h3>
            <p>
            ...
            <h3 className="text-lg font-semibold mb-2 mt-4">11. Binding Consent</h3>
            <p>
            ...
            <h3 className="text-lg font-semibold mb-2 mt-4">12. Contact</h3>
            <p>

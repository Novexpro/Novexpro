...
export default function MCXThirdMonthTrends() {
    ...
    // Rename stats to avoid unused variable warning
    ...
    }, [thirdMonthData, currentData.length]);
    ...
    // Add keyboard and scroll wheel support
    useEffect(() => {
                ...
                <div className="bg-white border border-gray-200 rounded-xl shadow-sm p-6 hover:shadow-md transition-shadow duration-300">
                    ...
                    <div className="h-[400px] relative" ref={chartContainerRef}>
                        ...
                        <ResponsiveContainer width="100%" height="100%">
                            ...
                            >
                                <defs>
                                    <linearGradient id="thirdMonthLineGradient" x1="0" y1="0" x2="1" y2="0">
